...
/**
 * set_hexadec_format - A function that set the format of haxadecimal
...
/**
 * set_octadec_format - A function that set the format for
...
/**
 * set_unsigned_int_format - A function that set the format for
 * printing unsigned
 * integer.
 * @list: The argument list
 * @fmat_spec: The format specifier details.
