 ...
 * @print: Pointer to the function that does the printing.
 */
struct print_specifier
{
	char specifier;
	void (*print)(va_list *args, fmat_spec_def *fmat_spec);
};


/**
 * union double_bits_union - A function that allows multiple
 * members to occupy
 ...
 * @un: The union name
 */
typedef union double_bits_union
{
	double duo;
	uint64_t bits;
} un;
...
/**
 * struct float_data - Struct function that represents the
 * IEE754 spec of a float
...
/*** Functions that set format to print1 ***/
void set_char_fmat(va_list *args, fmat_spec_def *fmat_spec);
void set_string_fmat(va_list *args, fmat_spec_def *fmat_spec);
void set_pointer_fmat(va_list *args, fmat_spec_def *fmat_spec);
void set_percent_fmat(va_list *args, fmat_spec_def *fmat_spec);
...
/*** Functions that set format to print3 ***/
